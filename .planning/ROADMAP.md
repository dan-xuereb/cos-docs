...
- [ ] 04-02-PLAN.md — `kubernetes` branch (from main) + Kustomize bundle: namespace/deployment/service/kustomization, NodePort 30083, control-plane toleration, 1 replica (DEPLOY-02, DEPLOY-03, DEPLOY-04)
